    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerHeros.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: avatarImage.setImageResource(R.drawable.sundiata_keita); break;
                    case 1: avatarImage.setImageResource(R.drawable.kwame_nkrumah); break;
                    case 2: avatarImage.setImageResource(R.drawable.kimpa_vita); break;
                    case 3: avatarImage.setImageResource(R.drawable.simon_kimbangu); break;
                    case 4: avatarImage.setImageResource(R.drawable.shaka_zulu); break;
                    case 5: avatarImage.setImageResource(R.drawable.nelson_mandela); break;
                    case 6: avatarImage.setImageResource(R.drawable.behanzin); break;
                    case 7: avatarImage.setImageResource(R.drawable.agojie); break;
                    default: avatarImage.setImageResource(R.drawable.default_avatar);
                }
            }
        ...
        button8.setOnClickListener(v -> {
            ...
            getSharedPreferences("ExplorateurData", MODE_PRIVATE)
                    ...
                    .putString("age", age)
                    .putString("sexe", sexe)
                    .putString("hero_choisi", spinnerHeros.getSelectedItem().toString())
                    .apply();
